...
% figure('Units','centimeters','Position',[0 0 4 3])
figure
%% ODE plot 
t_plot = [];
y_plot = [];
...
load(['TS T = T0*' num2str(period_multiplier) ', A1 = A10, A2 = A20.mat'])
t = TS{1};
y = TS{2}/0.06;
...
box on
%% circuit plot
TS_period_10 = readtable("1x_10_20.txt");
TS_period_10 = renamevars(TS_period_10,"x_____","t");
 
TS_period_15 = readtable("1.5x_10_20.txt");
TS_period_15 = renamevars(TS_period_15,"x_____","t");

TS_period_20 = readtable("2x_10_20.txt");
...
%% Save figure
name = ['fig_TS_triple' num2str(period_multiplier) 'x_P' num2str(index_PV)];
% exportgraphics(gcf, [name '.eps'], 'ContentType', 'vector','Width',4,'Height',3,'Units','centimeters');
