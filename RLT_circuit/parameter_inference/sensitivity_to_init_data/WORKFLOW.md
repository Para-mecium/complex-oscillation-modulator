...
FMAM parameter inference repeated over random initial guesses at five sampling-region scales (Fig. 4 sensitivity panels; Extended Data Fig. 5). Parent: [../WORKFLOW.md](../WORKFLOW.md). Global map: [FIGURE_WORKFLOW_MAP.md](../../../FIGURE_WORKFLOW_MAP.md).
...
| `draw_sensitivity_to_init_data.m` | Histograms, boxplots, scatter (scale = 1) | `results/scale_1/successful_params_*.png` → Extended Data Fig. 5 |
...
| Extended Data Fig. 5 | `draw_sensitivity_to_init_data` |
