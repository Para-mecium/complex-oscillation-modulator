...
FMAM period modulation with two amplitudes held fixed (three modulation targets); ODE vs hardware time-series panels (Extended Data Fig. 3, tri-target panels). Parent: [../WORKFLOW.md](../WORKFLOW.md). Global map: [FIGURE_WORKFLOW_MAP.md](../../FIGURE_WORKFLOW_MAP.md).
...
| Figure | Scripts |
|---|---|
| Extended Data Fig. 3 (tri-target parameter curves) | `draw_params` |
| Extended Data Fig. 3 (tri-target time series) | `draw_TS` |
