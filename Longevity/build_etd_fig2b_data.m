...
needPath = true;
%% Extended Fig 2b FMAM procedure
...
if needPath
    ...
    if isempty(solution_path)
        error('build_extended_fig2b_cache_fmam:NoContinuationLogs', ...
            ['No continuation logs for extended_fig2b_params_modulation_path. Increase lambdaStepCap ' ...
...
if ~poResult.has_orbit
    error('build_extended_fig2b_cache_fmam:PeriodicOrbitGenerationFailed', ...
