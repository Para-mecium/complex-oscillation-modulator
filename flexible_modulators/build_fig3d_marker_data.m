...
% Three Fig. 3d markers: (2.1, 60), (2.1, 80), (2.1, 100)
targetAmplitude = 2.1;
targetPeriod = 60;
...
saveFile = fullfile(markerDataDir, ...
    sprintf('fig3d_marker_A%s_T%03d.mat', amplitudeTag, round(targetPeriod)));
...
%% Single marker settings for Fig. 3d
...
if ~poResult.has_orbit
    error('flexmod_refactor:Fig3dMarkerPeriodicOrbitGenerationFailed', ...
