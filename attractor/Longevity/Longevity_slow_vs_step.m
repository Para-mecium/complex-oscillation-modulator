% Longevity oscillator: compare slow parameter modulation and a sudden jump.
...
pathFile = fullfile(repoDir, 'Longevity', 'beta_modulation_path.mat');
...
if ~initialOrbit.success
    error('Longevity_slow_vs_step:InitialOrbitFailed', ...
