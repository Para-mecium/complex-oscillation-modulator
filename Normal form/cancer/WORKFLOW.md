...
Closed-form AM/FM normal-form curves and FMAM comparison for the cancer gene-regulatory oscillator (Supplementary Fig. S16, cancer data). Shared utilities: `Normal form/+normalform/`. FHN counterpart: `Normal form/FHN/`. Global map: [FIGURE_WORKFLOW_MAP.md](../../FIGURE_WORKFLOW_MAP.md).
...
**Full rebuild (Supplementary Fig. S16, cancer data):**
...
| `plot_cancer_fmam_period_invariant.m` | FMAM AM vs normal-form AM | Supplementary Fig. S16 (period-invariant data) |
| `plot_cancer_fmam_amplitude_invariant.m` | FMAM FM vs normal-form FM | Supplementary Fig. S16 (amplitude-invariant data) |
...
| Figure | Scripts |
|---|---|
| Supplementary Fig. S16 (cancer normal-form curves) | `reproduce_cancer_normal_form` |
| Supplementary Fig. S16 (cancer FMAM comparison) | `run_cancer_fmam` → `plot_cancer_fmam_period_invariant`, `plot_cancer_fmam_amplitude_invariant` |
